                ...
                <div className='about-us'>
                    <Fade direction="down" damping={.2}>
                        <div className="about-me">
                            ...
                            <p>Bienvenue sur Oliv' Auto Clean, votre destination pour un lavage automobile de qualité supérieure. Je suis Olivier, le fondateur et propriétaire de cette entreprise, et je suis ravi de partager mon histoire avec vous.</p>
                        </div>
                        <div className="passion">
                            <h2>Ma Passion pour les Voitures</h2>
                            <p>Depuis que je suis enfant, j'ai toujours été passionné par les voitures. Qu'il s'agisse de leur design, de leur mécanique ou simplement de leur apparence, j'ai toujours été fasciné par cet univers. Mon rêve a toujours été de créer un espace où les amateurs de voitures peuvent prendre soin de leurs précieux véhicules.</p>
                        </div>
                        <div className="aventure">
                            <h2>L'Aventure Oliv' Auto Clean</h2>
                            <p>L'aventure Oliv' Auto Clean a commencé il y a quelques années lorsque j'ai décidé de concrétiser ce rêve. J'ai réuni une équipe dévouée de professionnels qui partagent ma passion pour les voitures et qui comprennent l'importance d'un lavage automobile de qualité. Notre mission est de fournir des services de lavage automobile exceptionnels et de garantir la satisfaction totale de nos clients.</p>
                        </div>
